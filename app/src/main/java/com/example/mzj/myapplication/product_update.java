...
public class product_update extends AsyncTask<String,String ,String> {

    Context context;

    product_update (Context ctx){
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        if (params[0].equals("add")){
            try {
                urls = "http://10.0.3.2/product_add.php";
            ...
            try {
                ...
                urls = "http://10.0.3.2/product_update.php";
                String name =  params[1];
                String price =  params[2];
                String stock =  params[3];
                String id =  params[4];
            ...
            try {
                ...
                urls = "http://10.0.3.2/product_delete.php";
                String name =  params[1];
